...
FORMAT="txt img_all npy img_groups" # can choose between [txt img_all npy img_groups], leaving this for now
...
TIME_END=104927054630296287 # End time to draw for IMG ALL
