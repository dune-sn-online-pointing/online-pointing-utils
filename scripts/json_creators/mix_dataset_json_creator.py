...
def main(args):
    ...
    types = ["main_tracks", "blips", "es-cc-bkg-truth"]
    dataset_path_img = f"{args.cut}dataset/dataset_img.npy"
    dataset_path_dir = f"{args.cut}dataset/dataset_label_true_dir"
    ...
    output_file_img = f"/afs/cern.ch/work/h/hakins/private/online-pointing-utils/lists/npy_files/img/ds-mix-mt-vs-all-{args.cut}.txt"
    with open(output_file_img, "w") as file:
        for path in paths_img:
            file.write(path + "\n")
    output_file_dir = f"/afs/cern.ch/work/h/hakins/private/online-pointing-utils/lists/npy_files/true_dir/ds-mix-mt-vs-all-{args.cut}.txt"
    ...
    "datasets_process_label": f"/afs/cern.ch/work/h/hakins/private/online-pointing-utils/lists/npy_files/process/ds-mix-mt-vs-all_{args.cut}.txt",
