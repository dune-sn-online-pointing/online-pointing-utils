...
cd ${REPO_HOME}/app/
python dataset_mixer.py --input_json ${REPO_HOME}/json/ds_mix/ds-mix-mt-vs-all.json --output_folder /eos/user/d/dapullia/dune/npy_datasets/ds-mix-mt-vs-all-reduced/
