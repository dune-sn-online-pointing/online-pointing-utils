...
python3 dataset_mixer.py --input_json ${REPO_HOME}/json/ds_mix/ds-mix-es-cc-volume.json --output_folder /eos/user/d/dapullia/dune/npy_datasets/ds-mix-es-cc-volume/
