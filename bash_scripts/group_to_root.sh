FILENAME=/afs/cern.ch/work/d/dapullia/public/dune/online-pointing-utils/lists/text_files/all_es_dir_list_2.txt
OUTFOLDER=/eos/user/d/dapullia/root_group_files/all_es_dir_list_2
TICK_LIMITS=3
CHANNEL_LIMIT=1
MIN_TPS_TO_GROUP=1
PLANE=2
