...
python groups_to_dataset.py --input_file /eos/user/d/dapullia/root_group_files/superimposed_files/cc-lab-bkg/superimposed_radius_50.000000.root --output_path /eos/user/d/dapullia/npy_datasets/superimposed_files/cc-lab-bkg-r50/ --min_tps_to_group $MIN_TPS_TO_GROUP --drift_direction $DRIFT_DIRECTION --save_img_dataset $SAVE_IMG_DATASET --save_process_label $SAVE_LABEL_PROCESS --save_true_dir_label $SAVE_LABEL_DIRECTION --img_width $IMG_WITDH --img_height $IMG_HEIGHT
python groups_to_dataset.py --input_file /eos/user/d/dapullia/root_group_files/superimposed_files/es-lab-bkg/superimposed_radius_50.000000.root --output_path /eos/user/d/dapullia/npy_datasets/superimposed_files/es-lab-bkg-r50/ --min_tps_to_group $MIN_TPS_TO_GROUP --drift_direction $DRIFT_DIRECTION --save_img_dataset $SAVE_IMG_DATASET --save_process_label $SAVE_LABEL_PROCESS --save_true_dir_label $SAVE_LABEL_DIRECTION --img_width $IMG_WITDH --img_height $IMG_HEIGHT
cd ../bash_scripts/
